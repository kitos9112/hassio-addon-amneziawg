...
### Changed
- Bump golang from `3ad5730` to `0178a64` in /amneziawg (#22)
- Bump golang from `0178a64` to `3889b42` in /amneziawg (#32)
...
### Documentation
- Clarify add-repo install (my.home-assistant caveat + manual URL) and document ghcr 401 → make-package-public fix (#11)

### Fixed
- Allow underscores in client names (#12)
